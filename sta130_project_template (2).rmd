...
neighbourhood %>% ggplot(aes(x = occurrencemonth)) + geom_bar() + ggtitle("Number of Auto Thefts Depending on the Months \nof the Year") +
  labs (x = "Month", y = "Number of Auto Thefts") + coord_flip()
neighbourhood %>% ggplot(aes(x = occurrencedayofweek)) + geom_bar() + ggtitle("Number of Auto Thefts Depending \non the Day of the Week")+
  labs (x ="Day of the Week", y = "Number of Auto Thefts") + coord_flip()
neighbourhood %>% ggplot(aes(x = occurrencehour)) + geom_bar() + ggtitle("Number of Auto Thefts Depending on the Time \nof the Day")+
