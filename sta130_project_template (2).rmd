...
3. Does the number of autothefts show a significant correlation depending on whether it is during the spring/summer or winter/fall at midnight?
...
neighbourhood %>% 
  ...
  ggtitle("Number of Autothefts based on Daytime \nvs Nighttime")+
